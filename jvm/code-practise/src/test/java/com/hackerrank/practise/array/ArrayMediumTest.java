...
//        assertEquals(new int[]{1}, topKFrequent(new int[]{1}, 1));
//        assertEquals(new int[]{1, 2}, topKFrequent(new int[]{1, 1, 1, 2, 2, 3}, 2));
//        assertEquals(new int[]{1, 0, 2}, topKFrequent(new int[]{2, 1, 1, 1, 1, 0, 0, 1, 1}, 2));
        topKFrequent(new int[]{2, 1, 1, 1, 1, 0, 0, 1, 1}, 2);
    }
}